...
NEXT_PUBLIC_URL=https://carpitg.raphael-varszegi.workers.dev
NODE_ENV=production
```

**Note**: Change `NEXT_PUBLIC_URL` to your actual production domain when you have a custom domain set up (e.g., `https://carpitgarage.hu`).
